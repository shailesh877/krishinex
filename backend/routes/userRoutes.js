    ...
    try {
        ...
        if (user) {
            res.json({
                ...
                aadhaarBackDocUrl: user.aadhaarBackDocUrl || '',
    ...
    try {
        ...
        if (user) {
            ...
            if (req.body.bankDetails) {
                ...
                const current = user.bankDetails || {};
                user.bankDetails = {
                    holderName: b.holderName !== undefined ? b.holderName : current.holderName || '',
                    bankName: b.bankName !== undefined ? b.bankName : current.bankName || '',
                    accountNumber: b.accountNumber !== undefined ? b.accountNumber : current.accountNumber || '',
                    ifscCode: b.ifscCode !== undefined ? b.ifscCode : current.ifscCode || '',
                    bankAddress: b.bankAddress !== undefined ? b.bankAddress : current.bankAddress || '',
                    bankDocUrl: current.bankDocUrl || ''
                };
            ...
            res.json({
                ...
                aadhaarBackDocUrl: updatedUser.aadhaarBackDocUrl || '',
...
router.post('/upload-aadhaar', protect, upload.single('aadhaar'), async (req, res) => {
    try {
        ...
        console.log(`[DEBUG] Saving user profile with new Aadhaar URL (${side}): ${fileUrl}`);
        await user.save();
