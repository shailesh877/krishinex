      ...
      steps: [
        {
          ...
          title: 'लॉगिन करें',
          desc: 'अपना मोबाइल नंबर डालें, OTP आएगा, उसे डालें और अपनी भूमिका (Shop Partner) चुनें।',
        },
        {
          icon: 'create-outline',
        ...
        {
          icon: 'cart-outline',
          title: 'ऑर्डर चेक करें',
          desc: '"डैशबोर्ड" या "ऑर्डर्स" में जाकर अपने नए ऑर्डर्स चेक करें जो किसानों ने किए हैं।',
        },
        {
          icon: 'checkmark-circle-outline',
          title: 'ऑर्डर स्वीकार करें',
          desc: 'नए ऑर्डर्स को Accept करें और किसान को डिलीवर करने के बाद Delivered मार्क करें।',
        },
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: '"ऑर्डर" टैब में जाकर कैंसल बटन दबाएं और वजह लिखें।',
        },
      ],
    },
    en: {
      ...
      steps: [
        {
          icon: 'person-add-outline',
          title: 'Login',
          desc: 'Enter your mobile number, receive an OTP, enter it, and select your role as Shop Partner.',
        },
        {
          icon: 'create-outline',
        ...
        },
        {
          icon: 'cart-outline',
          title: 'Check Orders',
          desc: 'Go to Dashboard or Orders tab to check new requests placed by farmers.',
        },
        {
          icon: 'checkmark-circle-outline',
          title: 'Accept Orders',
          desc: 'Accept new orders and mark them as Delivered once handled.',
        },
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: 'Go to the Orders tab, tap Cancel, and write a reason.',
        },
      ],
    },
  }[lang];
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Krishinex Shop Partner App</Text>
