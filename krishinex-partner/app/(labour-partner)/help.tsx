...
export default function HelpSupport() {
      ...
      steps: [
        {
          ...
          title: 'लॉगिन करें',
          desc: 'अपना मोबाइल नंबर डालें, OTP आएगा, उसे डालें और अपनी भूमिका (Labour Partner) चुनें।',
        },
        {
          icon: 'create-outline',
          title: 'प्रोफाइल पूरा करें',
          desc: 'अपना नाम, पता, रेट्स और आधार कार्ड अपलोड करें ताकि आपका अकाउंट वेरीफाई हो सके।',
        },
        {
          icon: 'briefcase-outline',
          title: 'बुकिंग चेक करें',
          desc: '"डैशबोर्ड" या "बुकिंग" में जाकर अपने नए काम चेक करें जो किसानों ने भेजे हैं।',
        },
        {
          icon: 'checkmark-circle-outline',
          title: 'काम स्वीकार करें',
          desc: 'नए काम को Accept करें और खेत में काम पूरा करने के बाद Completed मार्क करें।',
        },
      ],
      faqs: [
        {
        ...
        {
          q: 'बुकिंग कैंसल कैसे करें?',
          a: '"बुकिंग" टैब में जाकर कैंसल बटन दबाएं और वजह लिखें।',
        },
      ],
    },
    en: {
      ...
      steps: [
        {
          icon: 'person-add-outline',
          title: 'Login',
          desc: 'Enter your mobile number, receive an OTP, enter it, and select your role as Labour Partner.',
        },
        {
          icon: 'create-outline',
          title: 'Complete your profile',
          desc: 'Add your name, rates, address and upload your Aadhaar card so your account can be verified.',
        },
        {
          icon: 'briefcase-outline',
          title: 'Check Bookings',
          desc: 'Go to Dashboard or Bookings tab to check new job requests placed by farmers.',
        },
        {
          icon: 'checkmark-circle-outline',
          title: 'Accept Work',
          desc: 'Accept new requests and mark them as Completed once the field work is done.',
        },
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: 'Go to the Bookings tab, tap Cancel, and write a reason.',
        },
      ],
    },
  }[lang];
  ...
  const emailSupport = () => {
    Linking.openURL(`mailto:${EMAIL}?subject=Krishinex Shop Support`).catch(() =>
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Krishinex Labour Partner App</Text>
