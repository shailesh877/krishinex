      ...
      >
        <View style={styles.card}>
          ...
          <Text style={styles.sectionText}>
            {isHindi
              ? 'यह ऐप सिर्फ रजिस्टर्ड कृषि लेबर पार्टनर्स के लिए है. आप अपने अकाउंट की login जानकारी किसी और के साथ शेयर नहीं करेंगे.'
              : 'This app is only for registered agri labour partners. You agree not to share your login details with anyone else.'}
          </Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.sectionTitle}>
            {isHindi ? '2. बुकिंग और काम' : '2. Bookings and work'}
          </Text>
          <Text style={styles.sectionText}>
            {isHindi
              ? 'आप द्वारा accept किए गए सभी काम समय पर पूरा करने की जिम्मेदारी आपकी होगी. बिना बताए काम कैंसिल करने पर पेनल्टी लग सकती है.'
              : 'You are responsible for fulfilling all accepted field work on time. Cancelling work without notice may result in penalties.'}
          </Text>
        </View>
