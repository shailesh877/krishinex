...
function typeIcon(type: NotifType) {
  switch (type) {
    case 'order': return { name: 'briefcase-outline', color: '#16A34A', bg: '#ECFDF5' };
...
export default function LabourNotificationsScreen() {
  ...
  const markRead = async (id: string, refId?: string) => {
    ...
    // Optional: navigate to the booking if there's a reference. Not needed for now as we don't have a labour detail page.
  };
