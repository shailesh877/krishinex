      ...
      <div class="flex items-center justify-between h-16">
        ...
        <a href="index.html" class="flex items-center gap-2.5">
          ...
          <div class="leading-tight">
            ...
            <p class="text-[10px] text-gray-500 -mt-0.5 font-medium">Arkpire Technologies Pvt. Ltd.</p>
          </div>
        </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="lg:col-span-1">
          <a href="index.html" class="inline-flex items-center gap-2.5 mb-5">
            ...
            <div class="leading-tight">
              ...
              <p class="text-[10px] text-gray-500 -mt-0.5">Arkpire Technologies Pvt. Ltd.</p>
            </div>
          </a>
      ...
      <div class="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p class="text-xs text-gray-600 text-center sm:text-left">
          © 2026 KrishiNex (Arkpire Technologies Pvt. Ltd.). All rights reserved.
        </p>
