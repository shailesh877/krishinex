(function injectGlobalSleekScrollbar() {
    if (document.getElementById('krishinex-sleek-scrollbar-style')) return;
    const style = document.createElement('style');
    style.id = 'krishinex-sleek-scrollbar-style';
    style.textContent = `
        /* Sleek, Modern Custom Scrollbar System for KrishiNex Admin */
        ::-webkit-scrollbar {
            width: 6px !important;
...
(function () {
    ...
    const moduleMap = {
        ...
        'nex_card': 'nex_card_management.html' // Added so it gets hidden for employees
    };
